...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    KC_WHOM,  KC_TAB,        KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,      KC_P,     KC_BSPC,
    KC_PGUP,  CTL_T(KC_ESC), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      KC_SCLN,  KC_QUOT,
    KC_HOME,  TD(SFT_CPS),   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,   KC_ENT,
    KC_PGDN,  RGB_TOG,       KC_LCTRL, KC_LALT,  KC_LGUI,  LOWER,    KC_SPC,   KC_SPC,   RAISE,    KC_LEFT,  KC_DOWN,   KC_UP,    KC_RGHT
  ),
  ...
  /* LOWER
   *        ,-----------------------------------------------------------------------------------.
   *        |RGBPLN|RGBBRT|RGBRNB|RGBSWL|Sat(-)|Hue(-)|Hue(+)|Sat(+)|RGBGRD|RGBXMS|Brght-|Brght+|
   *        |------+------+------+------+------+-------------+------+------+------+------+------|
   *        |  `   |      |      |      |      |      |      |      |      |      |      |   =  |
   *        |-----------------------------------------------------------------------------------.
   *  RotEn |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
   ...
   */
    [_LOWER] = LAYOUT(
              RGB_M_P,  RGB_M_B,  RGB_M_R,  RGB_M_SW, RGB_SAD,  RGB_HUD,  RGB_HUI,  RGB_SAI,    RGB_M_G,    RGB_M_X,  RGB_VAD,  RGB_VAI,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case SHRUG:
      if (record->event.pressed) {
        //TODO: doesn't work, maybe because of the input mode?
