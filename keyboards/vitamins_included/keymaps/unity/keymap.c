 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  |  Alt |CapsLk|Raise |Space |Enter |Lower | Down |  Up  | Left |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTRL,KC_LGUI, KC_LALT, KC_CAPS, RAISE,   KC_SPC,  KC_ENT,  LOWER,   KC_DOWN, KC_UP,   KC_LEFT, KC_RGHT \
),
