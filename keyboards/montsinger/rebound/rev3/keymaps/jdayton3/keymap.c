...
[_QWERTY] = LAYOUT_all(
   ...
   TD(SHIFT_CAPS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , 
...
[_LOWER] = LAYOUT_all(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, KC_F12,S(KC_NUHS),S(KC_NUBS),KC_HOME,KC_END, KC_PSCR, 
